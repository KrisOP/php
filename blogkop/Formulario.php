...
<body>
<h2>Nueva entrada</h2>
<form action="Insertar_contenidos.php" method="post" enctype="multipart/form-data" name="form1">
<table >
<tr>
  <td>Título: 
  ...
  <tr><td colspan="2" align="center"><a href="inicio_blog.php">Página de visualización del blog</a></td></tr>
